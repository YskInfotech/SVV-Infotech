...
const Registercandidates = () => {
  ...
  const initialData = [
    ...
    { id: 5, name: "Arjun Reddy", appliedfor: "Data Analyst", email: "arjun@example.com", phone: "+91 8899776655", exp: 5, status: "Active" },
    { id: 6, name: "Kavya Nair", appliedfor: "Project Manager", email: "kavya@example.com", phone: "+91 7766554433", exp: 0, status: "Inactive" }
  ];
